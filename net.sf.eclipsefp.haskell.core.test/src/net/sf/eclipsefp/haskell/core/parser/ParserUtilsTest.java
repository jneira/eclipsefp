...
public class ParserUtilsTest extends TestCase {
  ...
  public void testIdentifier(){
    ...
    assertEquals(null,ParserUtils.getHaskellWord( line, 16 ));
    assertEquals(null,ParserUtils.getHaskellWord( line, line.length()-1 ));
    assertEquals(null,ParserUtils.getHaskellWord( line, line.length()));
    assertEquals(null,ParserUtils.getHaskellWord( line, 255));
  }
}
